...
/* Date inputs: iOS/WebKit centre the value and float the picker oddly — force left alignment and a
   consistent height so they match the text fields and selects. */
input.sel[type="date"] { -webkit-appearance: none; appearance: none; text-align: left; min-height: 47px; box-sizing: border-box; display: flex; align-items: center; }
input.sel[type="date"]::-webkit-date-and-time-value { text-align: left; margin: 0; }
input.sel[type="date"]::-webkit-calendar-picker-indicator { margin-left: auto; opacity: .55; cursor: pointer; }
