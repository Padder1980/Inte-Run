...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="form">
      ...
      <div class="field"><label>Recent 5k <span class="hintx">min:sec, optional</span></label><input class="time" id="fivek" placeholder="e.g. 24:00" inputmode="numeric" autocomplete="off"><div class="err" id="fivekErr"></div></div>
...
["rpw", "years", "vol", "fivek", "age"].forEach((id) => $(id).addEventListener("input", build));
